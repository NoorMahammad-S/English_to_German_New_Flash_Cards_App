...
try:
    data = pandas.read_csv("data/words_to_learn.csv", encoding='latin1')
...
window = Tk()
window.title("English to German Flash Cards Program")
...
card_word = canvas.create_text(400, 263, text="", font=("Areal", 40, "bold"))
